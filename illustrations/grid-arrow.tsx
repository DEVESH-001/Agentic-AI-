export const GridArrowIllustration = (
  ...
  return (
    <svg
      ...
      className="absolute -top-4 left-40 z-30 mx-auto"
      {...props}
    >
...
export const GridArrowIllustrationReverse = (
  props: React.SVGAttributes<SVGSVGElement>,
) => {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="absolute -bottom-10 left-32 mx-auto blur-[2px]"
      {...props}
    >
      <path
