...
export const Logo = ({ className }: { className?: string }) => {
  return (
    // <Link href={"/"} className={cn("flex items-center gap-1 cursor-pointer relative", className)}>
    //   {/* <StackMintLogo /> */}
    //   <span className="text-sm text-neutral-800 dark:text-neutral-200">Stackmint Studio</span>
    // </Link>
    <svg
      width="20"
      height="15"
